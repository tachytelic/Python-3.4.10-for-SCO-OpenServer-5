...
The full install is ~24 MB packaged. Grab `python-3.4.10-sco.tar.gz`
from the **Releases** page, copy it to your SCO box, and untar:

```sh
# scp the tarball to the SCO machine, then on SCO:
gunzip -c python-3.4.10-sco.tar.gz | tar xf -
